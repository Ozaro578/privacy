...
export const priorityScenarios: readonly PriorityScenario[] = [
  ...
  s({ id: "strassenbahn", media: "vt-strassenbahn-rvl", title: "Straßenbahn von links", vehicles: [{ key: "sie", label: "Sie" }, { key: "t", label: "Straßenbahn (von links)" }], order: [["sie"], ["t"]], level: 5,
    explanation: "Auch für Schienenfahrzeuge gilt an Kreuzungen ohne Zeichen rechts vor links: Die Straßenbahn kommt von links und muss warten. In der Praxis rechnen Sie trotzdem mit dem langen Bremsweg der Bahn.", legalReference: "§ 8 Abs. 1 StVO" }),
  // Zweite Staffel
  s({ id: "ampel-gruen-links", media: "vt-ampel-gruen-linksabbieger", title: "Beide Grün, Sie biegen links ab", vehicles: [{ key: "sie", label: "Sie (links, Grün)" }, { key: "a", label: "A (geradeaus, Grün)" }], order: [["a"], ["sie"]], level: 2,
    explanation: "Grün gibt beiden die Fahrt frei, regelt aber nicht den Vorrang untereinander. Als Linksabbieger müssen Sie den entgegenkommenden Geradeausverkehr durchfahren lassen.", legalReference: "§ 37 Abs. 2 und § 9 Abs. 3 StVO" }),
  s({ id: "gruenpfeil-fussgaenger", media: "vt-gruenpfeil-fussgaenger", title: "Rot mit Grünpfeilschild", vehicles: [{ key: "sie", label: "Sie (Grünpfeil, rechts)" }, { key: "a", label: "A (Grün, geradeaus)" }, { key: "p", label: "Fußgänger" }], order: [["a", "p"], ["sie"]], level: 3,
    explanation: "Mit dem Grünpfeilschild dürfen Sie bei Rot rechts abbiegen, aber erst nach dem Anhalten und nur, wenn Sie niemanden behindern oder gefährden: den freigegebenen Querverkehr A und den Fußgänger, der Ihre Zielstraße überquert.", legalReference: "§ 37 Abs. 2 Nr. 1 StVO, Zeichen 720" }),
  s({ id: "zeichen-301", media: "vt-zeichen-301", title: "Zeichen 301: Vorfahrt an der nächsten Kreuzung", vehicles: [{ key: "sie", label: "Sie (Zeichen 301)" }, { key: "a", label: "A (Zeichen 205)" }], order: [["sie"], ["a"]], level: 1,
    explanation: "Zeichen 301 gibt Ihnen an der nächsten Kreuzung Vorfahrt. A muss mit Zeichen 205 warten, auch wenn A von rechts kommt.", legalReference: "§ 8 Abs. 1 StVO, Zeichen 301 und 205" }),
  s({ id: "einbahnstrasse-rvl", media: "vt-einbahnstrasse-rvl", title: "Aus der Einbahnstraße von rechts", vehicles: [{ key: "sie", label: "Sie" }, { key: "a", label: "A (aus der Einbahnstraße)" }], order: [["a"], ["sie"]], level: 3,
    explanation: "Eine Einbahnstraße ist keine Vorfahrtregelung. Ohne Zeichen gilt rechts vor links, und A kommt für Sie von rechts.", legalReference: "§ 8 Abs. 1 StVO" }),
  s({ id: "rechts-fussgaenger", media: "vt-rechtsabbiegen-fussgaenger", title: "Rechtsabbiegen, Fußgänger auf der Zielstraße", vehicles: [{ key: "sie", label: "Sie (rechts)" }, { key: "p", label: "Fußgänger" }], order: [["p"], ["sie"]], level: 2,
    explanation: "Beim Abbiegen müssen Sie Fußgänger, die die Straße überqueren, in die Sie einbiegen, durchgehen lassen, notfalls warten.", legalReference: "§ 9 Abs. 3 Satz 3 StVO" }),
  s({ id: "links-fussgaenger-gegenverkehr", media: "vt-links-fussgaenger-gegenverkehr", title: "Linksabbiegen: Gegenverkehr und Fußgänger", vehicles: [{ key: "sie", label: "Sie (links)" }, { key: "a", label: "A (geradeaus)" }, { key: "p", label: "Fußgänger" }], order: [["a", "p"], ["sie"]], level: 4,
    explanation: "Als Linksabbieger lassen Sie zuerst den Gegenverkehr durch und dann den Fußgänger, der Ihre Zielstraße überquert. Beide haben Vorrang vor Ihnen, untereinander behindern sie sich nicht.", legalReference: "§ 9 Abs. 3 StVO" }),
  s({ id: "kreisverkehr-radweg", media: "vt-kreisverkehr-radweg", title: "Ausfahrt aus dem Kreisverkehr, Radweg außen", vehicles: [{ key: "sie", label: "Sie (ausfahren)" }, { key: "r", label: "Radfahrer (Radweg)" }], order: [["r"], ["sie"]], level: 3,
    explanation: "Das Verlassen des Kreisverkehrs ist ein Abbiegevorgang: Radfahrende auf dem umlaufenden Radweg, die geradeaus weiterfahren, müssen Sie durchfahren lassen. Blinken Sie rechts und schauen Sie über die Schulter.", legalReference: "§ 9 Abs. 3 und § 8 Abs. 1a StVO" }),
  s({ id: "polizist-seite", media: "vt-polizist-seite", title: "Polizist regelt den Verkehr", vehicles: [{ key: "sie", label: "Sie (sehen die Seite)" }, { key: "a", label: "A (sieht die Brust)" }], order: [["sie"], ["a"]], level: 3,
    explanation: "Zeichen des Polizisten gehen allen Regeln vor. Wer seine Seite sieht (die Arme zeigen in die eigene Fahrtrichtung), darf fahren; wer Brust oder Rücken sieht, muss warten.", legalReference: "§ 36 Abs. 1 und 2 StVO" }),
  s({ id: "ende-vorfahrtstrasse", media: "vt-ende-vorfahrtstrasse-rvl", title: "Ende der Vorfahrtstraße", vehicles: [{ key: "sie", label: "Sie (Zeichen 307)" }, { key: "a", label: "A (von rechts)" }], order: [["a"], ["sie"]], level: 2,
    explanation: "Zeichen 307 hebt die Vorfahrtstraße auf. An der nächsten Kreuzung ohne Zeichen gilt wieder rechts vor links, also fährt A zuerst.", legalReference: "§ 8 Abs. 1 StVO, Zeichen 307" }),
  s({ id: "grundstueck-a", media: "vt-grundstueck-a-rechts", title: "Anderer kommt aus der Grundstücksausfahrt", vehicles: [{ key: "sie", label: "Sie (Straße)" }, { key: "a", label: "A (Ausfahrt)" }], order: [["sie"], ["a"]], level: 2,
    explanation: "Wer aus einem Grundstück auf die Straße fährt, muss sich so verhalten, dass niemand gefährdet wird, und Sie durchfahren lassen. Rechts vor links gilt für Grundstücksausfahrten nicht.", legalReference: "§ 10 StVO" }),
  s({ id: "radfahrer-rvl", media: "vt-radfahrer-rvl", title: "Radfahrer von rechts", vehicles: [{ key: "sie", label: "Sie" }, { key: "r", label: "Radfahrer (von rechts)" }], order: [["r"], ["sie"]], level: 2,
    explanation: "Rechts vor links gilt für alle Fahrzeuge, auch für Fahrräder. Der Radfahrer von rechts fährt zuerst.", legalReference: "§ 8 Abs. 1 StVO" }),
  s({ id: "zebrastreifen", media: "vt-zebrastreifen", title: "Fußgängerüberweg", vehicles: [{ key: "sie", label: "Sie" }, { key: "p", label: "Fußgänger" }], order: [["p"], ["sie"]], level: 1,
    explanation: "Am Fußgängerüberweg müssen Sie Fußgängern, die erkennbar überqueren wollen, das Überqueren ermöglichen und notfalls warten. Nur mit mäßiger Geschwindigkeit heranfahren.", legalReference: "§ 26 Abs. 1 StVO, Zeichen 350" }),
  s({ id: "linienbus-abfahrt", media: "vt-linienbus-haltestelle", title: "Linienbus fährt von der Haltestelle ab", vehicles: [{ key: "sie", label: "Sie" }, { key: "bus", label: "Linienbus (blinkt links)" }], order: [["bus"], ["sie"]], level: 3,
    explanation: "Innerorts müssen Sie Linienbussen und Schulbussen das Abfahren von gekennzeichneten Haltestellen ermöglichen, notfalls warten.", legalReference: "§ 20 Abs. 5 StVO" }),
];
