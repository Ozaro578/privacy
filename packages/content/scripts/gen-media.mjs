...
fs.writeFileSync(path.join(OUT, "signs.catalog.json"), JSON.stringify(CATALOG.map((e) => ({ id: e.id, number: e.number, name: e.name, category: e.category, meaning: e.meaning, alt: e.alt })), null, 2) + "\n");
