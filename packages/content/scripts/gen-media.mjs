...
const miniAmpel = (x, y, state) => `<g transform="translate(${x} ${y})"><rect x="0" y="0" width="22" height="58" rx="5" fill="#1F2937"/><circle cx="11" cy="12" r="6" fill="${state === "r" ? "#E30613" : "#4B5563"}"/><circle cx="11" cy="29" r="6" fill="#4B5563"/><circle cx="11" cy="46" r="6" fill="${state === "g" ? "#00A651" : "#4B5563"}"/></g>`;
const PED = "#111827";
const cyclePath = (x, y, w, h) => `<rect x="${x}" y="${y}" width="${w}" height="${h}" fill="#B91C1C" opacity="0.55"/>`;
// Vorfahrt-Trainer, zweite Staffel
scene("vt-ampel-gruen-linksabbieger", "Kreuzung mit Ampeln, beide zeigen Grün: Ihr blaues Auto kommt von unten und will links abbiegen (Blinker links), ein rotes Auto A kommt von oben entgegen und fährt geradeaus.", 600, 600,
  crossroad("NESW") + miniAmpel(376, 372, "g") + miniAmpel(202, 170, "g") + car(330, 470, 0, CAR.you, "Sie", { blink: "L" }) + arrow("M330 430 V320 Q330 300 310 300 H230") + car(270, 130, 180, CAR.a, "A") + arrow("M270 170 V400") + legend([[CAR.you, "Sie (links, Grün)"], [CAR.a, "A geradeaus (Grün)"]]));
scene("vt-gruenpfeil-fussgaenger", "Kreuzung mit Ampel: Ihre Ampel zeigt Rot mit Grünpfeilschild (Zeichen 720), Sie wollen rechts abbiegen. Von links kommt ein grünes Auto A bei Grün geradeaus, und ein Fußgänger überquert die Straße, in die Sie einbiegen wollen.", 600, 600,
  crossroad("NESW") + miniAmpel(376, 372, "r") + signIn("720", 402, 380, 30) + miniAmpel(170, 372, "g") + car(330, 470, 0, CAR.you, "Sie", { blink: "R" }) + arrow("M330 430 V350 Q330 330 350 330 H440") + car(130, 330, 90, CAR.b, "A") + arrow("M170 330 H430") + person(410, 226, PED) + arrow("M410 238 V372", "#FACC15", 3) + caption(430, 232, "Fußgänger", 13) + legend([[CAR.you, "Sie (Grünpfeil)"], [CAR.b, "A (Grün)"], [PED, "Fußgänger"]]));
scene("vt-zeichen-301", "Kreuzung: Ihr blaues Auto kommt von unten, an Ihrer Zufahrt steht Zeichen 301 (Vorfahrt an der nächsten Kreuzung). Ein rotes Auto A kommt von rechts und hat Zeichen 205.", 600, 600,
  crossroad("NESW") + signIn("301", 378, 400, 40) + signIn("205", 380, 210, 34) + car(330, 470, 0, CAR.you, "Sie") + arrow("M330 430 V330") + car(470, 270, -90, CAR.a, "A") + arrow("M430 270 H340") + legend([[CAR.you, "Sie (Zeichen 301)"], [CAR.a, "A (Zeichen 205)"]]));
scene("vt-einbahnstrasse-rvl", "Kreuzung ohne Vorfahrtzeichen: Ihr blaues Auto kommt von unten. Von rechts kommt ein rotes Auto A aus einer Einbahnstraße (Zeichen 220, Pfeil zur Kreuzung).", 600, 600,
  crossroad("NESW") + signIn("220-20", 470, 196, 46) + car(330, 470, 0, CAR.you, "Sie") + arrow("M330 430 V330") + car(470, 270, -90, CAR.a, "A") + arrow("M430 270 H340") + caption(400, 184, "Einbahnstraße", 13) + legend([[CAR.you, "Sie"], [CAR.a, "A aus der Einbahnstraße"]]));
scene("vt-rechtsabbiegen-fussgaenger", "Kreuzung: Ihr blaues Auto will rechts abbiegen (Blinker rechts). Ein Fußgänger überquert gerade die Straße, in die Sie einbiegen wollen.", 600, 600,
  crossroad("NESW") + car(330, 470, 0, CAR.you, "Sie", { blink: "R" }) + arrow("M330 430 V350 Q330 330 350 330 H440") + person(410, 226, PED) + arrow("M410 238 V372", "#FACC15", 3) + caption(430, 232, "Fußgänger", 13) + legend([[CAR.you, "Sie (rechts)"], [PED, "Fußgänger"]]));
scene("vt-links-fussgaenger-gegenverkehr", "Kreuzung ohne Zeichen: Ihr blaues Auto will links abbiegen (Blinker links). Ein rotes Auto A kommt von oben entgegen und fährt geradeaus, ein Fußgänger überquert die Straße links, in die Sie einbiegen wollen.", 600, 600,
  crossroad("NESW") + car(330, 470, 0, CAR.you, "Sie", { blink: "L" }) + arrow("M330 430 V320 Q330 300 310 300 H230") + car(270, 130, 180, CAR.a, "A") + arrow("M270 170 V400") + person(190, 374, PED) + arrow("M190 362 V228", "#FACC15", 3) + caption(120, 392, "Fußgänger", 13) + legend([[CAR.you, "Sie (links)"], [CAR.a, "A geradeaus"], [PED, "Fußgänger"]]));
scene("vt-kreisverkehr-radweg", "Kreisverkehr mit Zeichen 215 und 205: Ihr blaues Auto fährt im Kreis und will an der nächsten Ausfahrt nach rechts hinaus. Um den Kreisverkehr führt ein Radweg; ein Radfahrer darauf fährt geradeaus weiter und kreuzt Ihre Ausfahrt.", 600, 600,
  roundabout(`<circle cx="300" cy="300" r="212" fill="none" stroke="#B91C1C" stroke-width="16" opacity="0.5"/>`) + signIn("215_205", 40, 400, 64) + car(300, 452, 90, CAR.you, "Sie", { blink: "R" }) + arrow("M340 452 Q440 430 480 318 H560") + bike(452, 448, 40) + arrow("M470 430 Q506 380 508 300 Q508 230 470 170", "#FACC15", 3) + caption(430, 560, "Radweg", 13) + legend([[CAR.you, "Sie (ausfahren)"], ["#7C3AED", "Radfahrer auf dem Radweg"]]));
scene("vt-polizist-seite", "Kreuzung mit Polizist in der Mitte: Er steht mit der Seite zu Ihnen, seine ausgestreckten Arme zeigen in Ihre Fahrtrichtung (nach oben und unten). Ihr blaues Auto kommt von unten. Ein rotes Auto A kommt von rechts und sieht die Brust des Polizisten.", 600, 600,
  crossroad("NESW") + `<g transform="translate(300 300)"><rect x="-8" y="-60" width="16" height="120" rx="8" fill="#1E3A8A"/><rect x="-16" y="-14" width="32" height="28" rx="8" fill="#1E3A8A"/><circle cx="0" cy="0" r="11" fill="#F5D0A9" stroke="#111827" stroke-width="1.5"/><rect x="-14" y="-6" width="6" height="12" rx="2" fill="${WHITE}"/><rect x="8" y="-6" width="6" height="12" rx="2" fill="${WHITE}"/></g>` + caption(316, 262, "Polizist", 13, WHITE) + car(330, 490, 0, CAR.you, "Sie") + arrow("M330 450 V380") + car(470, 270, -90, CAR.a, "A") + arrow("M430 270 H380") + legend([[CAR.you, "Sie (Seite)"], [CAR.a, "A (Brust)"]]));
scene("vt-ende-vorfahrtstrasse-rvl", "Kreuzung: An Ihrer Zufahrt von unten steht Zeichen 307 (Ende der Vorfahrtstraße), sonst keine Zeichen. Ein rotes Auto A kommt von rechts.", 600, 600,
  crossroad("NESW") + signIn("307", 374, 396, 48) + car(330, 470, 0, CAR.you, "Sie") + arrow("M330 430 V330") + car(470, 270, -90, CAR.a, "A") + arrow("M430 270 H340") + legend([[CAR.you, "Sie (Zeichen 307)"], [CAR.a, "A von rechts"]]));
scene("vt-grundstueck-a-rechts", "Ihr blaues Auto fährt auf einer Straße von links nach rechts. Rechts vor Ihnen will ein rotes Auto A aus einer Grundstücksausfahrt auf die Straße fahren.", 600, 600,
  `<rect width="600" height="600" fill="${GRASS}"/><rect x="0" y="180" width="600" height="120" fill="${ASPHALT}"/><line x1="0" y1="240" x2="600" y2="240" stroke="${WHITE}" stroke-width="3" stroke-dasharray="18 14"/><path d="M0 180 H600 M0 300 H370 M430 300 H600" stroke="${WHITE}" stroke-width="3" fill="none"/><rect x="370" y="300" width="60" height="220" fill="#9CA3AF"/><rect x="300" y="330" width="60" height="190" fill="#CBD5E1" stroke="#64748B"/>${caption(440, 470, "Grundstück", 13)}` +
  car(120, 270, 90, CAR.you, "Sie") + arrow("M160 270 H330") + car(400, 400, 0, CAR.a, "A") + arrow("M400 360 V290 Q400 270 420 270 H470") + legend([[CAR.you, "Sie (Straße)"], [CAR.a, "A (Ausfahrt)"]]));
scene("vt-radfahrer-rvl", "Kreuzung ohne Zeichen: Ihr blaues Auto kommt von unten, von rechts kommt ein Radfahrer auf der Fahrbahn.", 600, 600,
  crossroad("NESW") + car(330, 470, 0, CAR.you, "Sie") + arrow("M330 430 V330") + bike(480, 278, -90) + arrow("M450 278 H340", "#FACC15", 3) + legend([[CAR.you, "Sie"], ["#7C3AED", "Radfahrer von rechts"]]));
scene("vt-zebrastreifen", "Gerade Straße mit Fußgängerüberweg (Zebrastreifen, Zeichen 350): Ihr blaues Auto kommt von unten, rechts wartet ein Fußgänger erkennbar am Rand, um die Straße zu überqueren.", 600, 600,
  crossroad("NS") + `<g fill="${WHITE}">${[0, 1, 2, 3, 4, 5, 6].map((i) => `<rect x="${244 + i * 17}" y="270" width="10" height="60" rx="2"/>`).join("")}</g>` + signIn("350-10", 378, 380, 40) + car(330, 490, 0, CAR.you, "Sie") + arrow("M330 450 V370") + person(392, 300, PED) + arrow("M378 300 H228", "#FACC15", 3) + caption(404, 306, "Fußgänger", 13) + legend([[CAR.you, "Sie"], [PED, "Fußgänger am Überweg"]]));
scene("vt-linienbus-haltestelle", "Innerorts: Ein Linienbus steht in einer Haltestellenbucht rechts, blinkt links und will abfahren. Ihr blaues Auto kommt von unten auf der Fahrbahn.", 600, 600,
  crossroad("NS") + `<rect x="360" y="170" width="60" height="180" fill="${ASPHALT}"/><path d="M360 170 H420 V350 H360" stroke="${WHITE}" stroke-width="3" fill="none"/>` + signIn("224", 428, 190, 34) + car(392, 262, 0, CAR.bus, "BUS", { length: 90, width: 30, blink: "L" }) + arrow("M392 214 Q392 170 340 150 V90", "#FACC15", 3) + car(330, 500, 0, CAR.you, "Sie") + arrow("M330 460 V330") + caption(430, 340, "Haltestelle", 13) + legend([[CAR.you, "Sie"], [CAR.bus, "Linienbus (Blinker links)"]]));
...
fs.writeFileSync(path.join(OUT, "signs.catalog.json"), JSON.stringify(CATALOG.map((e) => ({ id: e.id, number: e.number, name: e.name, category: e.category, meaning: e.meaning, alt: e.alt, ...(e.note ? { note: e.note } : {}) })), null, 2) + "\n");
