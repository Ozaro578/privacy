...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ next?: string; registriert?: string; bestaetigen?: string; fehler?: string }> }) {
  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-md flex-col justify-center p-6">
      ...
      {params.bestaetigen && <p className="mb-4 rounded-xl bg-success-100 p-3 text-sm">Fast geschafft: Wir haben dir eine E-Mail geschickt. Bitte bestätige den Link darin, danach kannst du dich anmelden.</p>}
