...
const PUBLIC_PREFIXES = ["/vorschau", "/login", "/registrieren", "/anmeldung", "/auth", "/datenschutz", "/nutzungsbedingungen", "/impressum", "/_next", "/api/webhooks", "/favicon.ico", "/manifest.webmanifest"];
